...
struct Slide {
    ...
    Slide(imageName: "onboarding2", title: "Facilidade", description: "Um cartão de visitas é uma ferramenta muito importante para o networking. E na era digital, porque não um virtual?"),
